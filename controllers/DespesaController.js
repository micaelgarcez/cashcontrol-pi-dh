...
function lista(id, anofiltro, mesfiltro) {
  const lista = con.query(
    "Select c.id, c.valor, c.obs, c.carteira_id, c.categoria_id, t.nome carteira, s.nome categoria, " +
      ...
      "where c.usuario_id=:id AND YEAR(c.data_despesa)=:anofiltro AND MONTH(c.data_despesa)=:mesfiltro order by c.data_despesa desc, c.id desc",
    {
      replacements: {
        id,
        anofiltro,
...
module.exports = {
  async store(req, res) {
    ...
    if (listaDeErros.isEmpty()) {
      ...
      const despesas = await lista(id, anofiltro, mesfiltro);
      ...
      res.render("crud-despesas/despesa", {
        categorias,
        carteiras,
  ...
  async list(req, res) {
    ...
    res.render("crud-despesas/despesalist", { despesas, Periodo });
  },
  async edit(req, res) {
  ...
  async update(req, res) {
    ...
    if (listaDeErros.isEmpty()) {
      ...
      const despesas = await lista(usuario_id, anofiltro, mesfiltro);
